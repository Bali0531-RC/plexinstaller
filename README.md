...
> **Branch:** `windows-experimental` — a standalone Windows-only port of PlexInstaller. This branch will **not** be merged into `main`; the Linux version lives in the `linux/` reference folder.
